...
import { Gamepad2, Puzzle, BrainCircuit, Hand, HelpCircle, Flag, VenetianMask, User, Clapperboard, Sparkles, HeartCrack, Dices, Flame } from 'lucide-react';
...
const games = [
    ...
    {
        name: 'Truth or Dare',
        description: 'A fun online version of the classic party game.',
        icon: Flame,
